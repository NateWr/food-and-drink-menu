...
class fdmWidgetMenu extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'layout' ); ?>"> <?php _e( 'Menu Layout Style' ); ?></label>
			<select id="<?php echo $this->get_field_id( 'layout' ); ?>" name="<?php echo $this->get_field_name( 'layout' ); ?>">
				<option value="classic"<?php if ( $layout == 'classic' ) : ?> selected<?php endif; ?>><?php _e( 'Classic' ); ?></option>
				<option value="enlarged"<?php if ( $layout == 'enlarged' ) : ?> selected<?php endif; ?>><?php _e( 'Enlarged' ); ?></option>
			</select>
		</p>
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( $new_instance['layout'] == 'enlarged' ) {
			$instance['layout'] = $new_instance['layout'];
		} else {
			$instance['layout'] = 'classic';
		}
