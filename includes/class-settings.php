	...
	public function load_settings_panel() {
		...
		$sap->add_setting(
			...
			array(
				...
				'description'	=> __( 'The width in pixels of menu item thumbnails automatically generated by WordPress. Leave this field empty to preserve the default (600).', 'food-and-drink-menu' )
			)
		);
		$sap->add_setting(
			'food-and-drink-menu-settings',
			...
			array(
				...
				'description'	=> __( 'The height in pixels of menu item thumbnails automatically generated by WordPress. Leave this field empty to preserve the default (600).', 'food-and-drink-menu' )
			)
		);
